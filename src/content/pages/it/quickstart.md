...
adatti allo stack. L’onboarding installa la revisione locale AI Diff Reviewer richiesta (il suo gate CI resta
opzionale) e offre quattro addon opt-in — devcontainer, Dailybot, dependency-upgrade e design-system — che accetta solo quando sono pertinenti. Un repo è pienamente conforme con zero addon opzionali.
