...
description: "वह स्किल और उसकी नौ सब-स्किल्स, कमांड्स, एजेंट अडैप्टर, ऑनबोर्डिंग प्रीसेट, ऑप्ट-इन ऐडऑन, और उदाहरण जो Deep Work Plan को कहीं भी चलाने योग्य बनाते हैं।"
...
Deep Work Plan स्किल एक राउटर और नौ सब-स्किल्स है:
...
- **upgrade** — इंस्टॉल की गई स्किल को सुरक्षित रूप से नए रिलीज़ पर ले जाता है (`/dwp-upgrade`)।
...
वे क्षमताएँ जिन्हें onboard प्रवाह किसी रिपॉज़िटरी पर परत के रूप में जोड़ता है। चार वैकल्पिक हैं और कभी AI-first आधाररेखा का हिस्सा नहीं; AI Diff Reviewer स्थानीय समीक्षा संस्करण 2.3.0 से आवश्यक है:
...
- **Design system** — रिपॉज़िटरी के वास्तविक डिज़ाइन स्रोत से तर्क की गई एक इंटरफ़ेस-दायरे वाली `DESIGN.md` (`docs/DESIGN.md` पर, `AGENTS.md` से संदर्भित), विज़ुअल UI, शैलीबद्ध CLI आउटपुट और संवादात्मक संदेशों के लिए प्रोफ़ाइलों के साथ, ताकि एजेंट ऑन-ब्रांड इंटरफ़ेस आउटपुट बनाएँ; एक डिज़ाइन सिस्टम का पता चलने पर प्रस्ताव अनिवार्य है लेकिन इंस्टॉल स्पष्ट स्वीकृति से नियंत्रित है — विज़ुअल प्रोफ़ाइल पता चलने पर पुरज़ोर सिफ़ारिश है, CLI और संवादात्मक प्रोफ़ाइल पता चलने पर अनुशंसित हैं और हमेशा पूछे जाते हैं।
- **AI Diff Reviewer** — आवश्यक स्थानीय समीक्षा: ऑनबोर्डिंग [AI Diff Reviewer](https://github.com/DailybotHQ/ai-diff-reviewer) v2 + `.review/extension.md` इंस्टॉल करती है, और हर Final Review की सुरक्षा-जाँच उसे चलाती है; वैकल्पिक Flow B उसी extension को साझा करने वाला CI PR मर्ज गेट जोड़ता है, जो स्पष्ट रूप से प्रस्तावित होता है और बिना अनुरोध कभी इंस्टॉल नहीं किया जाता।
