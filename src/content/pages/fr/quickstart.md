...
commandes adaptés à votre stack. L’onboarding installe la revue locale requise d’AI Diff Reviewer (sa porte CI reste
facultative) et propose quatre addons facultatifs — devcontainer, Dailybot, dependency-upgrade et design-system — que vous acceptez seulement lorsqu’ils conviennent. Un dépôt est pleinement conforme avec zéro addon facultatif.
