...
Quá trình khởi tạo cũng đề xuất năm addon tự nguyện — devcontainer, Dailybot,
dependency-upgrade, design-system và AI Diff Reviewer — mà bạn chỉ chấp nhận khi chúng phù hợp. Một repo hoàn toàn tuân thủ với không cần addon nào.
