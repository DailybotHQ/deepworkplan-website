...
If this policy changes materially, the updated date on the [policy page](https://deepworkplan.com/privacy) changes with it, and substantive edits are committed to the public website repository where anyone can review the history.

## Contact and security

For privacy questions write to [security@dailybot.com](mailto:security@dailybot.com). To report a security vulnerability, prefer GitHub's private vulnerability reporting for the website and skill repositories — see [security.txt](https://deepworkplan.com/.well-known/security.txt) for the exact addresses.
