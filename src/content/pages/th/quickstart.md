...
ที่เหมาะกับเทคสแตก การออนบอร์ดติดตั้งการตรวจสอบในเครื่องของ AI Diff Reviewer ที่จำเป็น (CI gate ของมันยังคง
เป็นทางเลือก) และเสนอส่วนเสริมแบบเลือกเข้าร่วมสี่อย่าง — devcontainer, Dailybot, dependency-upgrade และ design-system — ที่คุณยอมรับเมื่อมันเหมาะสมเท่านั้น repo สอดคล้องอย่างสมบูรณ์โดยมีส่วนเสริมแบบเลือกใช้ศูนย์อย่าง
