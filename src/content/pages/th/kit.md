...
- **AI Diff Reviewer** — เสริม Security Review ด้วยการตรวจสอบในเครื่องแบบมีโครงสร้าง ([AI Diff Reviewer](https://github.com/DailybotHQ/ai-diff-reviewer) v2 + `.review/extension.md` ที่ต้องการ); Flow B แบบเลือกได้เพิ่ม CI PR merge gate ที่ใช้ extension เดียวกัน ถามเสมอว่า Flow A หรือ Flow B; อย่าติดตั้งอัตโนมัติ
