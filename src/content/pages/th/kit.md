...
- **Dailybot** — การรายงานตามวงจรชีวิตของแผน (kickoff, งานสำคัญ, ติดขัด, เสร็จสิ้น) สำหรับทีมที่ใช้ Dailybot พร้อมการเข้าถึง Dailybot agent skill เต็มรูปแบบ (3.10.3: แชต check-in ฟอร์ม ถาม AI คีย์ API ต่อ repo และอื่น ๆ)
- **Dependency upgrade** — การอัปเกรดที่เป็นกลางต่อตัวจัดการแพ็กเกจ ทำเป็นชุด ตรวจสอบแล้ว และย้อนกลับได้
- **Design system** — `DESIGN.md` ที่จำกัดขอบเขตเฉพาะอินเทอร์เฟซ (ที่ `docs/DESIGN.md` อ้างอิงจาก `AGENTS.md`) ซึ่งให้เหตุผลจากแหล่งดีไซน์จริงของ repo พร้อมโปรไฟล์สำหรับ UI เชิงภาพ เอาต์พุต CLI ที่จัดสไตล์ และการส่งข้อความเชิงสนทนา เพื่อให้เอเจนต์สร้างเอาต์พุตอินเทอร์เฟซที่ตรงแบรนด์ โปรไฟล์เชิงภาพเปิดใช้งานเป็นค่าเริ่มต้นเมื่อตรวจพบระบบดีไซน์ ส่วนโปรไฟล์ CLI และเชิงสนทนาถูกแนะนำเมื่อตรวจพบและถูกถามเสมอ
- **AI Diff Reviewer** — การตรวจสอบในเครื่องที่จำเป็น: การออนบอร์ดติดตั้ง [AI Diff Reviewer](https://github.com/DailybotHQ/ai-diff-reviewer) v2 + `.review/extension.md` และการตรวจความปลอดภัยของทุก Final Review รันมัน; Flow B แบบเลือกได้เพิ่ม CI PR merge gate ที่ใช้ extension เดียวกัน โดยถูกเสนออย่างชัดเจนและไม่เคยถูกติดตั้งโดยไม่ได้ร้องขอ
