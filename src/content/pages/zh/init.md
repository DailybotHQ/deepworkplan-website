...
- **报告问题。** 安全问题请发送至 security@dailybot.com——详见 `https://deepworkplan.com/.well-known/security.txt` 和各仓库的 `SECURITY.md`。公开的信任页面位于 `https://deepworkplan.com/trust`。
