...
Adicione a skill ao seu repositório. Ela traz um roteador mais nove sub-skills — create, execute, refine,
resume, status, verify, onboard, author e upgrade. Use a CLI de Skills para o caminho mais rápido:
...
agents e commands apropriados à sua stack. O onboarding instala a revisão local obrigatória do AI Diff Reviewer (sua barreira de CI
continua opcional) e oferece quatro addons opcionais — devcontainer, Dailybot, dependency-upgrade e design-system — que você aceita apenas quando fizerem sentido. Um repositório é totalmente conforme com zero addons opcionais.
