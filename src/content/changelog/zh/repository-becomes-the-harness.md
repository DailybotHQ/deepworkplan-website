---
title: "DWP v2：仓库成为代理运行框架"
description: "Deep Work Plan 的首个正式发布，让代码仓库本身成为代理的工作运行框架——上下文、防护栏、验证与状态，全部原生地存在于仓库之中。"
date: 2026-07-16
version: "v2 · 正式发布"
kind: foundation
lang: zh
...
这次发布为此后的一切奠定基础。计划不再是交给单次会话的孤立文档，而是成为代码仓库原生系统的一部分——任何兼容的代理都可以检查它、核验其合规性，并从上一次会话结束的地方精确地继续下去。
