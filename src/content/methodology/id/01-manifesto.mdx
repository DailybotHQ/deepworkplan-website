...
<RepoAsHarness lang="id" class="not-prose my-10" />
...
Tidak satu pun dari ini diklaim bebas kehilangan secara konstruksi, dan tidak satu pun dipasarkan dengan persentase yang dikarang. Byte instruksi yang dibutuhkan setiap alur diukur dan diterbitkan; klaim perilakunya didukung oleh pengujian ulang dengan kesalahan yang sengaja ditanam. Yang dapat dikatakan dengan gamblang adalah ini: agent membaca lebih sedikit hal yang tidak ia perlukan, menjalankan ulang lebih sedikit hal yang tidak berubah, dan lebih sering mengambil keputusan tepat di tempat bukti berada — dan penghematan itu terakumulasi sepanjang horizon yang panjang.
