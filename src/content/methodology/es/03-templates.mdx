...
description: "La estructura de los archivos de plan y de tarea, las tres tareas finales obligatorias y las convenciones de README y PROGRESS que mantienen legible el plan."
order: 3
lang: es
...
## Las tres tareas finales obligatorias

Todo plan debe terminar con tres tareas estándar. Aseguran que el trabajo quede auditado, que se capture el conocimiento y que se informe a las partes interesadas:

1. **Revisión de seguridad**: auditar todo lo que el plan cambió en busca de secretos, riesgos de inyección y nueva superficie de ataque, y mantener `docs/SECURITY.md` al día. La seguridad no es un flujo de trabajo aparte añadido al final: cada plan deja sus propios cambios auditados, y un hallazgo crítico bloquea la finalización.
2. **Descubrimiento de habilidades y agentes**: identificar las habilidades y agentes reutilizables creados durante el plan, para que el trabajo se acumule más allá de este esfuerzo puntual.
3. **Informe ejecutivo**: un resumen conciso de los resultados, escrito para las partes interesadas, que distingue lo entregado de lo que queda pendiente.
