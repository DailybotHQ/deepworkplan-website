...
description: "El flujo de crear, ejecutar, refinar, reanudar, estado y verificar; el directorio de salida .dwp ignorado por git; la anatomía de tarea y la validación."
order: 2
lang: es
