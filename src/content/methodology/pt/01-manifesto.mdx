...
Nada disso afirma ser sem perdas por construção, nem é promovido com porcentagens inventadas. Os bytes de instrução que cada fluxo exige são medidos e publicados; as afirmações comportamentais são respaldadas por replays com falhas semeadas. O que se pode dizer claramente é isto: o agente lê menos do que não precisa, reexecuta menos do que não mudou e decide mais onde a evidência vive — e essas economias se acumulam ao longo de um horizonte longo.
