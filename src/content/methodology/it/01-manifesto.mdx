...
Nulla di questo dichiara di essere senza perdite per costruzione, né viene promosso con percentuali inventate. I byte di istruzione che ogni flusso richiede sono misurati e pubblicati; le affermazioni comportamentali sono supportate da replay con errori seminati. Ciò che si può dire chiaramente è questo: l’agente legge meno di ciò che non gli serve, riesegue meno di ciò che non è cambiato e decide più dove vive l’evidenza — e questi risparmi si compongono lungo un orizzonte lungo.
