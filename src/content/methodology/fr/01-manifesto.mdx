...
Rien de tout cela ne prétend être sans perte par construction, ni n’est promu avec des pourcentages inventés. Ce qui peut se dire simplement : l’agent lit moins ce dont il n’a pas besoin, réexécute moins ce qui n’a pas changé et décide davantage là où se trouve la preuve — et ces économies se composent sur un long horizon.
