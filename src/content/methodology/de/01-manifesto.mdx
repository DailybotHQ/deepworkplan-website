...
Nirgends steht die Behauptung, all das sei von Grund auf verlustfrei, und nirgends wird mit erfundenen Prozentwerten geworben. Die Instruction-Bytes, die jeder Ablauf benötigt, werden gemessen und veröffentlicht; die Aussagen zum Verhalten sind durch Replays mit gezielt eingeschleusten Fehlern belegt. Was sich nüchtern sagen lässt: Der Agent liest weniger, das er nicht braucht, führt weniger erneut aus, das sich nicht geändert hat, und entscheidet mehr dort, wo die Belege liegen — und diese Einsparungen summieren sich über einen langen Horizont.
