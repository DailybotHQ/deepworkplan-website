...
- **create** — Einen neuen Plan aus einem Ziel erzeugen. Im geführten Modus wird der Plan als überarbeiteter Entwurf zur Review vorbereitet; im Trust-Modus materialisiert er direkt — Analyse und Qualitätsprüfungen laufen in jedem Fall. Der Agent analysiert das Ziel, zerlegt es in aufeinanderfolgende Aufgaben und schreibt die Plandateien. Bei einem mehrdeutigen Ziel sollte er vor dem Schreiben klärende Fragen stellen.
