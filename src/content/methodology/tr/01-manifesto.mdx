...
Bunların hiçbiri, yapı gereği kayıpsız olduğu iddiasıyla sunulmaz ve hiçbiri uydurma yüzdelerle pazarlanmaz. Her akışın gerektirdiği yönerge baytları ölçülür ve yayımlanır; davranışsal iddialar, bilinçli olarak eklenmiş hatalarla yapılan yeniden çalıştırmalarla desteklenir. Açıkça söylenebilecek şey şudur: ajan, ihtiyacı olmayanı daha az okur; değişmeyeni daha az yeniden çalıştırır ve kararları kanıtın bulunduğu yerde daha çok verir — ve bu tasarruflar uzun bir ufuk boyunca birikir.
