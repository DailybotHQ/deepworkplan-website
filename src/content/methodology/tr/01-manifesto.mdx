...
Deep Work Plan, bu yukarı yöndeki işi kalıcı, tekrarlanabilir bir biçimde yapma disiplinidir. İki kurucu direği, iyi yönün iki yarısıdır: bir **spesifikasyon** “doğru”nun neye benzediğini belirtir ve bir **harness** ajana ona ulaşması için bağlamı ve araçları verir. Üçüncü bir disiplin, bu birleşimi büyük ölçekte uygun maliyetli tutar: **token verimliliği** — çünkü işe yarayan bir harness, ajanın uzun bir ufuk boyunca gerçekten taşıyabileceği harness’tır. Birlikte, bir modelin ham yeteneğini güvenilir mühendisliğe dönüştürürler — saatlerce süren bir görev boyunca sürdürülen ve oturumlar arasında değişen ajanlar boyunca korunan biçimde.
...
Her öğe bir aracın özelliği değil, depodaki bir dosya olduğu için harness, yapısı gereği taşınabilirdir: Markdown okuyan ve kabuk komutları çalıştırabilen herhangi bir ajan, araç başına özel bir çerçeveye gerek kalmadan aynı dosyaları açabilir. Metodolojinin geri kalanının üzerine dayandığı tek satırlık iddia budur: *deponun kendisi harness haline gelir*. Bu, deponun taşıdığı şeye dair bir iddiadır; bir modelin yardımsız, taze bir istekte doğru akışı güvenilir biçimde bulacağının garantisi değildir — kit'in açık `dwp-*` giriş noktalarını ve bir yönlendirici `SKILL.md`'yi de bu yüzden sunması: dosya taşınabilirliği ile güvenilir yönlendirme farklı özelliklerdir ve yalnızca birincisi tek başına yapı gereği inşa edilmiştir.

## Yapı gereği verimli

İlk direk işi doğru kılar; ikincisi onu taşınabilir kılar. Üçüncüsü onu **uygun maliyetli** tutar — çünkü bağlam, bir kodlama ajanının sahip olduğu en kıt kaynaktır ve onu israf eden bir metodoloji, tam da iş uzamaya başladığında başarısız olur.

Üç mekanizma işi yapar:

- **Kademeli açığa çıkarma.** Ajan, olmazsa olmaz bir çekirdeği okur; her rehber ya da spesifikasyon bölümü yalnızca akışın kendi tetikleyicisi devreye girdiğinde yüklenir. Ajan, ihtiyaç duyduğu bölümü taşır, kitabın tamamını değil.
- **Dokunulan yüzeye göre seçilen doğrulama.** Her görev neyi değiştirdiğini kaydeder ve kapısını risk sınıfına göre seçer — küçük, izole bir değişiklik kendisini dar biçimde kanıtlar; paylaşılan makineye dokunan bir değişiklik kendisini geniş biçimde kanıtlar. Doğrulama alışkanlığa göre değil, etkiye göre seçilir.
- **Görev içinde öğrenme.** Bir görev yeniden kullanılabilir bir örüntü ürettiğinde karar, kanıtın taze olduğu yerde — o görevin içinde — verilir; kimsenin okumadığı bir geriye dönük değerlendirmede değil.

Bunların hiçbiri, yapı gereği kayıpsız olduğu iddiasıyla sunulmaz ve hiçbiri uydurma yüzdelerle pazarlanmaz. Her akışın gerektirdiği yönerge baytları ölçülür ve yayımlanır; davranışsal iddialar, bilinçli olarak eklenmiş hatalarla yapılan yeniden çalıştırmalarla desteklenir; ve taze aracılarla bir değerlendirme — aynı iki özellik; harness olmadan, önceki ana sürümle ve bu sürümle inşa edildi — donmuş bir protokol altında artık yürütüldü. Yabancının ilk gününde mekanizmaların ne teslim ettiğini ölçtü: harness taşıyan ağaçtaki aracılar her iki görevde harness bulunmayan kontrolden daha az byte okudu ve bu sürümün özellik oturumları, harness’in raporladığı gibi, tek bir iş yükünde önceki ana sürümünkinden daha az model girdi ve çıktısı tüketti. Aynı değerlendirme sınırları da açıkça işaretler. Onboarding, akışlar kullanıldığında geri ödeyen tek seferlik bir maliyettir ve beş taze çalışmada hiçbir aracı akışlara kendi başına girmedi — akışlar sizin ya da onları çağırmayı bilen bir aracının çalıştırdığı komutlardır. Aynı ağaçtaki ikinci özellik, harness bulunmayan kontrol dâhil, ölçülen her yapılandırmada daha az maliyetli oldu: bu amortismanın bir kısmı ağacın kendisine aittir ve harness onu bilinçli kılmak için vardır.
