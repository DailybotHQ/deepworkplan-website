...
Nic z tego nie jest obiecane jako wolne od strat z samej konstrukcji i nic z tego nie jest reklamowane wymyślonymi procentami. Liczba bajtów instrukcji, których wymaga każdy przepływ, jest mierzona i publikowana; twierdzenia o zachowaniu opierają się na odtworzonych przebiegach z podłożonymi błędami. Mówiąc wprost: agent czyta mniej tego, czego nie potrzebuje, ponownie uruchamia mniej tego, co się nie zmieniło, i częściej decyduje tam, gdzie leżą dowody — a te oszczędności rosną na długim dystansie.
