---
title: Додатки
description: "Опційні розширення DWP: чотири shipping-аддони (devcontainer, Dailybot, dependency-upgrade, design-system), контракт аддона та концепції kit (скіли, агенти, пресети, адаптери, приклади)."
order: 5
lang: uk
section: Addons
---
