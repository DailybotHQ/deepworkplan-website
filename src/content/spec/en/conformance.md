...
5. **A gitignored `.dwp/` workspace.** The repository MUST contain a `.dwp/` directory with `plans/`, and `.dwp/` MUST be gitignored. A `tmp/` scratch space SHOULD exist and SHOULD be gitignored.
