...
**संस्करण 2.1.0.** ऐडऑन कोर Deep Work Plan पद्धति के विस्तार हैं। पाँच में से चार वैकल्पिक हैं और **अनुरूपता के लिए कभी आवश्यक नहीं** — शून्य वैकल्पिक ऐडऑन वाली रिपॉज़िटरी पूर्णतः AI-first और DWP-अनुरूप है। हर वैकल्पिक ऐडऑन ऑनबोर्डिंग के दौरान प्रस्तावित होता है, स्पष्ट रूप से स्वीकार या अस्वीकार होता है, और — स्वीकार होने पर — मौजूदा सेटअप को मिटाने के बजाय **समाधान** करता है। एक घटक घोषित अपवाद है: संस्करण 2.3.0 से **AI Diff Reviewer स्थानीय समीक्षा** आवश्यक baseline का हिस्सा है — ऑनबोर्डिंग इसे इंस्टॉल करती है और हर Final Review इसे चलाता है — जबकि इसकी CI सतह ऑप्ट-इन बनी रहती है।
...
**[AI Diff Reviewer](https://github.com/DailybotHQ/ai-diff-reviewer)** (marketplace **"AI Diff Reviewer"**) अनिवार्य Final Review सुरक्षा-जाँच को एक संरचित स्थानीय समीक्षा देता है, और वैकल्पिक रूप से CI में pull requests को गेट करता है। संस्करण 2.3.0 से **स्थानीय समीक्षा baseline का हिस्सा है**; केवल CI सतह ऑप्ट-इन है। यह ऐडऑन हर release पर स्वतः अपडेट होता है, इसलिए इसका वर्तमान संस्करण कभी इस लेख में स्थिर नहीं किया जाता — वास्तव में vendored किया गया tag जानने के लिए ऐडऑन के अपने `SKILL.md` या उसकी GitHub releases देखें।
