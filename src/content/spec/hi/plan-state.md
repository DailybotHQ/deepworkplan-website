...
`state.json` को एजेंट द्वारा इन प्रोटोकॉल बिंदुओं में से प्रत्येक पर MUST पुनर्लिखा जाना चाहिए: योजना मैटेरियलाइज़ेशन (सभी कार्य `pending`), कार्य प्रारंभ (`in_progress`), प्रत्येक सत्यापन-गेट रन (गेट रिकॉर्ड जोड़ा या अद्यतन), कार्य पूर्णता (`completed`, [DWP विनिर्देश](/spec/dwp-specification#task-completion-protocol) में कार्य-पूर्णता प्रोटोकॉल के भाग के रूप में), किसी भी नियोजित रुकावट से पहले एक चेकपॉइंट, और एक `blocked` ठहराव।
...
सामान्य प्रगति-लेखन पूरी फ़ाइल के पुनर्लेखन के बजाय स्किल के साथ वितरित एक लक्षित अपडेटर से होकर गुज़रते हैं। यह गलत-फ़ॉर्मैट स्थिति को सीधे अस्वीकार करता है, और बिना गैर-रिक्त गेट-साक्ष्य जुड़े किसी कार्य को `completed` अंकित करने से इनकार करता है — जिस कमांड के अपने आउटपुट में pipe वर्ण हों उसके लिए `--gate-json` रूप उपलब्ध है, और अपडेटर ऊपर वर्णित वही बंद गेट-ऑब्जेक्ट स्वीकार करता है। पुनः-प्रयास केवल अपने ही कमांड को प्रतिस्थापित करते हैं; अलग कमांड अपना स्वतंत्र रिकॉर्ड रखते हैं। `--block-reason` एक अवरोध दर्ज करता है; `--resolve-blocker` केवल वर्तमान कार्य के अवरोध को हल करता है, कभी किसी अन्य कार्य के अवरोध को नहीं। छोड़े गए काम से कोई योजना कभी `completed` नहीं बन सकती। `--reopen-reason` कॉलर के `refine` के माध्यम से योजना में संशोधन के इरादे को दर्ज करता है — वह संशोधन, और जो साक्ष्य वह अमान्य करता है, दोनों को पहले कार्य-लॉग में MUST दर्ज करना चाहिए। `--expected-sha256` किसी ऐसे state snapshot के विरुद्ध लेखन को अस्वीकार करता है जो उसके बाद आगे बढ़ चुका है। एक सहयोगी `.lock` डायरेक्टरी समवर्ती लेखकों को क्रमबद्ध करती है; किसी क्रैश हुए लेखक के lock का MUST हटाने से पहले निरीक्षण करना चाहिए, और lock को पूरी तरह दरकिनार करने वाले एडिटर के विरुद्ध कोई सुरक्षा दावा नहीं की जाती। ये रिकॉर्ड परिणामों का दावा करते हैं — वे स्वयं यह सिद्ध नहीं करते कि कोई कमांड वास्तव में चला, या उसका आउटपुट अर्थपूर्ण रूप से स्वीकृत हुआ।

## सत्यापित योजना-प्रकाशन

पूर्णता की घोषणा से पहले, समाप्त हो चुके कार्य-लॉग (हर एक अपनी **स्किल्स निपटान** और, Final Review में, अपना **दस्तावेज़ीकरण निर्णय** साथ रखता हुआ), README index, और `PROGRESS.md` को अर्जित स्रोत और स्वीकृति परिणामों से MUST लिखा जाना चाहिए। योजना का अंतिम कार्य फिर वितरित finalizer के माध्यम से बंद होता है: इसका अंतिम संक्रमण स्थिति लिखने से पहले पूर्ण उम्मीदवार को हर योजना-कलाकृति के विरुद्ध सत्यापित करता है, उसके बाद फ़ाइलों को सत्यापित करता है, और एक `analysis_results/FINALIZATION.json` रसीद दर्ज करता है। किसी गढ़े हुए पासिंग गेट को MUST NOT इस संक्रमण का समर्थन करना चाहिए — यह रसीद इस बात का बाहरी प्रमाण है कि वास्तव में क्या जाँचा गया, कभी अपनी ही पूर्वशर्त नहीं। इसके बाद डिस्क पर वास्तविक कलाकृतियों के विरुद्ध `bash ../verify/conformance.sh --plan PLAN_name` चलता है।

बाधित प्रकाशन एक `.finalizing.json` मार्कर छोड़ जाता है; जब तक साक्ष्य की जाँच नहीं होती और रिकवरी हेल्पर उसी उम्मीदवार के विरुद्ध सफल नहीं होता, सामान्य सत्यापन विफल होता रहता है — कोई भी चीज़ अनुमान से प्रकाशन को फिर शुरू नहीं करती। एक पुराना सहयोगी lock हटाने से पहले यह पुष्टि माँगता है कि कोई लेखक अब भी सक्रिय नहीं है। इस परत में कुछ भी commit, push, संग्रहीत गेट कमांड निष्पादित, या योजना के markdown को चुपचाप ठीक नहीं करता। Python इंटरप्रेटर के अभाव में `UNVERIFIED` परिणाम आता है, कभी `completed` नहीं।

## साक्ष्य-सत्यता और संशोधन

किसी कार्य के दायरे, स्वीकृति मानदंड, या स्थगन में हर परिवर्तन एक टिकाऊ संशोधन-रिकॉर्ड वहन करता है: मूल मानदंड ज्यों-का-त्यों, जो देखा गया, निपटान, कारण, उसके पीछे का प्राधिकार (उपयोगकर्ता, डेवलपर, या साक्ष्य), प्रभावित कार्य, और कौन-सा साक्ष्य अमान्य या संरक्षित हुआ। संशोधन जोड़े जाते हैं, कभी पूर्वदिनांकित नहीं होते; `manifest.json` अपनी निर्माण-उत्पत्ति बनाए रखता है और किसी बदले हुए सजीव दायरे से मेल खाने के लिए कभी फिर से नहीं लिखा जाता।

पाँच साक्ष्य-अवस्थाएँ बताती हैं कि किसी कार्य-रिकॉर्ड को किसके विरुद्ध बंद किया जा सकता है:

- **पूर्ण जाँच** — वास्तव में दर्ज किया गया काम; यह किसी कार्य को केवल उस संशोधित मानदंड के विरुद्ध बंद करता है जो उसे नाम देता है, कभी मूल मानदंड के विरुद्ध नहीं जैसा वह लिखा गया था।
- **अनिष्पादित परिदृश्य** — न किए जाने के रूप में दर्ज; किसी भी युग में यह पासिंग साक्ष्य में योगदान नहीं करता।
- **स्थगित आवश्यकता** — मानदंड दर्ज प्राधिकार सहित एक नामित गंतव्य कार्य में स्थानांतरित हो जाता है; केवल वही संशोधन स्रोत को बंद करता है।
- **विफल गेट** — जब तक वही स्वीकृति-इरादा पुनः चलाकर पास नहीं होता, विफल बना रहता है; पुनः-प्रयास केवल अपने ही कमांड को प्रतिस्थापित करता है।
- **प्राप्त उत्पाद-परिणाम** — जैसा लिखा गया वैसा ही मानदंड, अपने ही गेट द्वारा सत्यापित; एकमात्र अवस्था जो किसी कार्य को बिना बदलाव के पूर्ण करती है।

प्रवर्तन जहाँ तक रिकॉर्ड अनुमति दें, यांत्रिक है। "refine द्वारा अमान्य" के रूप में चिह्नित गेट-साक्ष्य संरक्षित इतिहास है, कभी पासिंग साक्ष्य नहीं, और उस पर अब भी निर्भर कोई पूर्ण कार्य जाँचकर्ता द्वारा रिपोर्ट किया जाता है। एक पासिंग रिकॉर्ड जिसका अपना पाठ स्वीकार करता हो कि जाँच कभी चली ही नहीं (उदाहरण के लिए "कभी प्रवेश नहीं हुआ," "नहीं चला," या "मापा नहीं जा सकता") एक विरोधाभास है, उसी तरह रिपोर्ट किया जाता है — जैसे कोई पूर्ण-अवस्था कार्य जिसका अपना लॉग अब भी `Status: pending` पढ़ता हो। इनसे परे कथात्मक विरोधाभास — जिसकी रिपोर्ट के निष्कर्ष उसकी अपनी चेकलिस्ट से असहमत हों — मानव समीक्षक की माँग करते हैं; जाँचकर्ता वही रिपोर्ट करता है जो रिकॉर्ड कहते हैं, न कि गद्य का अर्थ। एक उपयोगकर्ता दर्ज प्राधिकार सहित किसी सीमित अपवाद को स्पष्ट रूप से स्वीकार कर MAY; अनुपस्थित पूर्व-अनुमोदन कभी किसी मूल उद्देश्य को त्यागने की व्यापक अनुमति नहीं है, और कोई अपूर्तनीय अनिवार्य मानदंड एक अवरोध है, कभी पूर्ण किया गया काम नहीं।
