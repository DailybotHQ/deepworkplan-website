---
title: ส่วนเสริม
description: "addon ของ DWP: สี่ส่วนขยายแบบเลือกใช้, การตรวจสอบในเครื่องของ AI Diff Reviewer ที่จำเป็นพร้อมพื้นผิว CI แบบเลือกใช้, สัญญา addon และแนวคิด kit"
order: 6
lang: th
section: Addons
---
