...
**Version 1.1.** Ce protocole définit comment un agent de code IA MUST se comporter lorsqu’il travaille avec des Deep Work Plans. Les mots-clés MUST, SHOULD et MAY suivent la RFC 2119.
