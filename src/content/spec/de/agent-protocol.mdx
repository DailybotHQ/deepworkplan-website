...
**Version 1.3.** Dieses Protokoll definiert, wie sich ein KI-Coding-Agent verhalten MUSS, wenn er mit Deep Work Plans arbeitet. Die Schlüsselwörter MUSS, SOLLTE und KANN folgen RFC 2119.
...
<AgentLifecycle lang="de" class="not-prose my-10" />
...
- Jede Aufgabe mit der zehnteiligen Anatomie schreiben — die Touched Surface hält fest, was die Aufgabe ändert, und wählt ihr Validierungs-Gate nach Risikoklasse.
- Mit dem einen verpflichtenden Final Review enden (Sicherheitstest, Validierung des Endzustands, Abgleich der Skills-Entscheidungen).
...
- Von einem bestandenen Gate ohne Bestätigungsnachfrage zur nächsten Aufgabe übergehen; bei einem fehlschlagenden Gate Reparaturen innerhalb des autorisierten Umfangs der Aufgabe versuchen — mit einer konkreten Hypothese und nach zwei Versuchen ohne neue Erkenntnisse keine blinden Wiederholungen mehr.
- Nur an einer echten Genehmigungsgrenze oder einem ungelösten Blocker anhalten und nachfragen, statt zu raten.
...
Ein Mensch ist in der Sitzung anwesend. Der Agent schlägt vor, der Mensch genehmigt den materialisierten Plan direkt, der Agent führt Aufgabe für Aufgabe aus, und Unklarheiten werden durch Nachfragen gelöst. Alle obigen Protokollabschnitte beschreiben das interaktive Profil.
...
- **Vorab genehmigter Plan.** Der Plan wurde vor jedem unbeaufsichtigten Turn genehmigt — im geführten Modus genehmigte der Mensch den materialisierten Plan direkt; im Trust-Modus ist die explizite `trust`-Anweisung des Entwicklers die aufgezeichnete Genehmigung. Ein Agent DARF NICHT ohne eines von beidem in einem Turn unbeaufsichtigt einen Plan erstellen und ausführen; die Plan-Genehmigung ist der menschliche Kontrollpunkt.
