---
title: Complementos
description: "Extensiones opcionales de DWP: los cuatro addons activos (devcontainer, Dailybot, dependency-upgrade, design-system), el contrato de addon y conceptos del kit."
order: 5
lang: es
section: Addons
---
...
## Addons activos (cuatro)

Hoy hay cuatro addons activos. Cada uno tiene una **página del catálogo del kit** con detalle orientado al usuario y una **spec normativa** dentro de la skill de Deep Work Plan.
...
- **Qué conecta el addon de DWP:** cuatro reportes del ciclo de vida del plan (inicio, tarea significativa, bloqueado, finalización) vía la sub-skill `report` de dailybot; refuerzo determinístico opcional mediante hooks (`dailybot hook`, CLI `>= 3.1.2`)
- **Skill emparejada:** instalar [DailybotHQ/agent-skill](https://github.com/DailybotHQ/agent-skill) (actualmente **3.4.0**) expone **13 capacidades** — chat en Slack/Teams/Discord/Google Chat, check-ins, autoría de formularios, ask AI, kudos, correo y más. El addon de DWP solo conecta **report**; el resto de capacidades se invocan directamente mediante la skill de Dailybot
