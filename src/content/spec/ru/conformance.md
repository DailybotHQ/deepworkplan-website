...
**Версия 1.2. Статус: стабильная.** Этот документ определяет, что значит для репозитория быть *соответствующим Deep Work Plan* — то есть AI-first и пилотируемым агентами. Ключевые слова MUST, MUST NOT, SHOULD, SHOULD NOT и MAY следует трактовать так, как описано в RFC 2119.
