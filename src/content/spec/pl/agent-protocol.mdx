...
- **Wstępnie zatwierdzony plan.** Plan został zatwierdzony przed jakąkolwiek turą nieobsługiwaną — w trybie guided człowiek zatwierdził dopracowany szkic; w trybie trust jawna instrukcja `trust` programisty jest zapisanym zatwierdzeniem. Agent NIE MOŻE bez żadnego z nich tworzyć i wykonywać planu nieobsługiwanego w jednej turze; zatwierdzenie planu jest ludzkim punktem kontrolnym.
