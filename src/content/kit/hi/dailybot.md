...
कोर Deep Work Plan पद्धति की Dailybot पर **शून्य** निर्भरता है। शून्य वैकल्पिक ऐडऑन वाली रिपॉज़िटरी पूर्णतः अनुरूप है। यह ऐडऑन केवल तभी प्रस्तावित करें जब डेवलपर या टीम पहले से Dailybot उपयोग करती हो; कभी सभी के लिए स्वतः इंस्टॉल न करें।
...
DWP `onboard` के दौरान **Phase 7b** में, कोर AI-first scaffolding के बाद, प्रवाह चार ऑप्ट-इन ऐडऑन प्रस्तावित करता है (AI Diff Reviewer स्थानीय समीक्षा पहले ही Phase 7a में इंस्टॉल हो चुकी थी)। यदि डेवलपर Dailybot स्वीकार करता है:
