...
Основна методика Deep Work Plan має **нульову** залежність від Dailybot. Репозиторій без опційних аддонів повністю відповідає вимогам. Пропонуйте цей аддон лише коли розробник або команда вже використовує Dailybot; ніколи не встановлюйте автоматично для всіх.
...
| **Email** | Надсилання email з обовʼязковими перевірками безпеки перед відправкою |
...
Під час DWP `onboard` у **Phase 7b**, після основного AI-first scaffolding, потік пропонує чотири опційні аддони (локальний огляд AI Diff Reviewer уже було встановлено у Phase 7a). Якщо розробник приймає Dailybot:
