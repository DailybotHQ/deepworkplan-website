...
description: "A before-and-after example showing how a Deep Work Plan changes an agent's behavior on a multi-step task, turning improvisation into reviewable, resumable execution."
kind: example
lang: en
order: 1
---
