...
2. Check a plan (when requested): every task has acceptance criteria and a validation gate, progress is persisted, the three mandatory final tasks are present (Security Review included), and tasks re-anchor to the goal.
