...
2. Check a plan (when requested): every task has acceptance criteria and a validation gate, progress is persisted, the recorded Final Review is present (its security pass included), and tasks re-anchor to the goal.
