---
title: dwp-resume
description: "Resume an interrupted Deep Work Plan by reconstructing state from the progress log and task files, then continuing from the first incomplete task."
kind: command
lang: en
order: 4
