---
title: dwp-execute
description: "Ejecuta un Deep Work Plan existente tarea por tarea. El agente lee el plan completo, recorre cada tarea en orden, actualiza el avance y marca la finalización."
kind: command
lang: es
order: 2
