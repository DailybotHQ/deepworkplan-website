...
export const ru: SiteTranslations = {
  ...
  home: {
    ...
    outcomes: {
      ...
      items: [
        ...
        {
          label: '.agents/ с символьной ссылкой .claude на .agents',
          detail:
  ...
  quickstartPage: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          'Запустите под-навык onboard и позвольте агенту рассудить о вашем реальном репозитории. Он создаёт AGENTS.md, базу знаний docs/, документацию по модулям и межагентный дом .agents/ (с символьной ссылкой .claude → .agents), подключает тонкие команды dwp-* и разворачивает игнорируемую git-ом .dwp/.',
        commands: ['/deepworkplan-onboard'],
      },
      {
        title: 'Развивайте набор и принимайте дополнения',
        description:
          'Используйте /skill-create и /agent-create (под-навык author), чтобы растить навыки, агентов и команды, подходящие вашему стеку. Онбординг также предлагает три опциональных дополнения — devcontainer, Dailybot и dependency-upgrade, — которые вы принимаете, только когда они уместны.',
      },
      {
  ...
  initPage: {
    ...
    handoffTitle: 'Передайте это своему агенту',
    handoffBody:
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          'Вызовите под-навык onboard и позвольте агенту рассудить о реальном репозитории — его стеке, менеджере пакетов и реальных командах валидации. Затем он создаёт AGENTS.md, базу знаний docs/, документацию по модулям и межагентный дом .agents/ (с символьной ссылкой .claude → .agents), подключает тонкие команды dwp-* и разворачивает игнорируемую git-ом .dwp/ для планов и черновиков. Ничего не берётся из шаблона; всё адаптируется под ваш репозиторий.',
        commands: ['/deepworkplan-onboard'],
      },
      {
        title: 'Развивайте набор и принимайте дополнения',
        description:
          'Используйте /skill-create и /agent-create (под-навык author), чтобы растить навыки, агентов и команды, подходящие вашему стеку. Онбординг также предлагает три опциональных дополнения — devcontainer, Dailybot и dependency-upgrade, — которые вы принимаете, только когда они уместны. Репозиторий полностью соответствует стандарту и с нулём дополнений.',
      },
      {
        title: 'Планируйте и выполняйте',
        description:
          'Создавайте Deep Work Plan с помощью /dwp-create и выполняйте их через /dwp-execute, затем /dwp-status, /dwp-refine и /dwp-resume по ходу работы. Каждый план содержит пронумерованные задачи, validation gates и протокол завершения, чтобы работа оставалась структурированной, пригодной для ревью и возобновляемой между сессиями.',
      },
    ],
    outcomeTitle: 'Результат',
    outcome:
