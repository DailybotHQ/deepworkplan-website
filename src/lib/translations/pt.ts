...
export const pt: SiteTranslations = {
  ...
  announcementBar: {
    badge: 'Novo · Eficiente em contexto por construção',
  ...
  home: {
    ...
    hero: {
      ...
      copiedLabel: 'Copiado',
      viewInitCta: 'Ver o início rápido',
      pullQuote:
    ...
    quickstart: {
      ...
      steps: [
        ...
        },
        {
          ...
          description:
            'A skill é o motor — o mesmo em todos os repositórios. Um comando importa o roteador e suas sub-skills (create, execute, refine, resume, status, verify, onboard, author, upgrade) para Claude Code, Cursor, Codex, Gemini e Copilot.',
        },
        {
    ...
    outcomes: {
      ...
      items: [
        ...
        },
        {
          ...
          detail:
            'create, execute, refine, resume, status, verify, onboard, author e upgrade — disponíveis ao seu agente como um único pacote de skills, sem cópia por repositório.',
        },
        {
  ...
  kitPage: {
    meta: {
      ...
      description:
        'A skill e suas nove sub-skills, commands, adaptadores, presets, addons opcionais e exemplos que tornam o Deep Work Plan executável em diversos agentes e stacks.',
    },
    eyebrow: 'Kit',
    title: 'O Kit',
    intro:
    ...
    groups: {
      command: {
        ...
        description:
          'O roteador da skill e suas sub-skills (create, execute, refine, resume, status, verify, onboard, author, upgrade), além dos slash commands enxutos que delegam a elas.',
      },
      adapter: {
        title: 'Adaptadores',
        description:
  ...
  quickstartPage: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          'Gere Deep Work Plans com /dwp-create e execute-os com /dwp-execute, depois /dwp-status, /dwp-refine, /dwp-resume e /dwp-verify conforme o trabalho avança. Cada plano carrega tarefas numeradas, validation gates e um protocolo de conclusão — e se encerra com um único Final Review obrigatório (passe de segurança, validação de estado final e reconciliação de skills). O Executive Report permanece disponível sob pedido.',
    ...
    groups: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            question: 'O que exatamente é instalado, e onde?',
            answer:
            ...
            linkLabel: 'Veja o fluxo de adoção',
            linkPath: '/quickstart',
          },
          {
            id: 'requires-git',
            question: 'O Deep Work Plan exige Git?',
            answer:
            ...
            linkLabel: 'Leia sobre os arquétipos de repositório',
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            id: 'unverified',
            question:
              'O que acontece quando o verificador de conformidade não consegue executar suas verificações?',
            answer:
              'Ele diz isso com todas as letras. O verificador encerra com código de saída 2 e um veredito `UNVERIFIED` explícito — nunca imprime uma aprovação que não tenha verificado de verdade. Quando o ambiente não tem um intérprete capaz ou uma verificação não pode rodar, o resultado honesto é «não verificado», não «conforme»; um resultado verde sempre significa que cada verificação foi executada e passou. A mesma disciplina percorre toda a metodologia: nenhum fluxo enfraquece ou forja um gate para declarar a conclusão do trabalho.',
            linkLabel: 'O contrato de conformidade',
      ...
      },
      {
        ...
        items: [
          {
            id: 'multi-repo',
            question: 'Um plano pode abranger vários repositórios?',
            answer:
              'Sim — o arquétipo de hub orquestrador existe exatamente para isso. Um repositório hub mantém o plano que coordena, e cada repositório filho executa o próprio plano dentro da sua própria área `.dwp/` isolada, de modo que um filho nunca escreve no estado de planos do hub. A completude do filho é lida do estado de nível superior do próprio plano de cada um, não por busca de strings dentro dele, e o hub registra onde está antes de navegar para qualquer lugar. Cada filho continua um repositório DWP comum, que também pode ser pilotado sozinho.',
            linkLabel: 'Arquétipos de repositório',
            linkPath: '/spec/archetypes',
          },
          {
            id: 'vs-sdd-tools',
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            id: 'upgrade',
            question:
              'Como faço o upgrade da skill em um repositório já integrado?',
            answer:
              'São dois upgrades diferentes, e o fluxo os mantém separados. O harness do repositório — `AGENTS.md`, `docs/`, o kit `.agents/` — é reconciliado reexecutando o onboarding, que preenche apenas o que falta ou está desatualizado. A skill em si avança com `/dwp-upgrade`: uma verificação somente leitura da última versão publicada, a instalação da tag exata que você aceitou, verificada, e depois o onboarding novamente como uma passada nova. O fluxo é condicionado a consentimento explícito do início ao fim, as adaptações locais são comparadas e preservadas em vez de sobrescritas, e `.dwp/` nunca é migrado — os planos existentes mantêm a forma registrada e continuam rodando.',
            linkLabel: 'O endpoint de adoção',
            linkPath: '/quickstart',
          },
          {
  ...
  comparePage: {
    ...
    capabilities: {
      ...
      crossProjectMemory: {
        label: 'Memória persistente do agente entre projetos',
        help: 'A memória acompanha o agente entre diferentes repositórios e sessões, não apenas o estado em disco de um único plano.',
      },
      roleBasedAgents: {
        label: 'Papéis de agente especializados e distintos',
        help: 'Personas nomeadas (como analista, arquiteto ou revisor) dividem o trabalho, em vez de um único agente executar cada etapa.',
      },
      nativeIdeProduct: {
        label: 'É, em si, um IDE ou editor',
        help: 'A ferramenta é um ambiente de desenvolvimento integrado por si só, não um complemento a um agente de código já existente.',
      },
    },
    alternatives: {
      dwp: {
      ...
      'github-spec-kit': {
        ...
        whatItDoesWell:
          'Transforma uma funcionalidade em uma especificação executável por meio de uma constituição, uma especificação, um plano e uma lista de tarefas, dirigida por slash commands que se integram a mais de cinquenta agentes de código, e pode verificar se os artefatos permanecem consistentes entre si antes de a implementação começar.',
        audience:
      ...
      openspec: {
        name: 'OpenSpec',
        whatItDoesWell:
          'Captura cada mudança como uma proposta com specs delta (adicionadas, modificadas, removidas) e requisitos RFC 2119 com cenários, e então as arquiva em especificações vivas, com um validador que verifica a completude da proposta e a cobertura dos cenários antes de aceitar uma mudança.',
        audience:
      ...
      'bmad-method': {
        name: 'BMAD Method',
        whatItDoesWell:
          'Um framework ágil de papéis de agente especializados (análise, produto, arquitetura, desenvolvimento, qualidade) que produz briefs, requisitos, documentos de arquitetura e arquivos de story, com uma Definition of Done que exige que cada story seja revisada por um colega de equipe ou um agente revisor de IA antes de ser considerada concluída.',
        audience:
      ...
      superpowers: {
        name: 'Superpowers',
        whatItDoesWell:
          'Uma biblioteca de skills e um fluxo de trabalho para brainstorming, planejamento em pequenos passos de teste primeiro, execução com subagentes e revisão antes da conclusão, integrada a mais hosts de agentes de código do que qualquer outra alternativa desta página, além de uma revisão em dois estágios com subagentes (conformidade com a especificação e depois qualidade do código) em cada tarefa.',
        audience:
      ...
      'gentle-ai': {
        name: 'Gentle-AI',
        whatItDoesWell:
          'Configura os agentes de código que você já usa com memória persistente que também roteia entre sessões e modelos, skills curadas, servidores MCP, personas e Spec-Driven Development ou Receipt-Driven Development opcionais. A sua configuração é escrita, por padrão, nas configurações globais do agente; uma instalação limitada ao workspace é opcional.',
        audience:
          'Desenvolvedores que querem um ecossistema de agentes configurado, capaz de lembrar o trabalho entre sessões e produzir evidências sob demanda.',
      },
      'claude-ai-native-sdlc': {
        name: 'SDLC nativo de IA da Claude',
        whatItDoesWell:
          'Um ciclo de seis estágios, de Plan e Design a Build, Test, Deploy e Maintain, com aprovação humana obrigatória em cada estágio, artefatos duradouros comitados no repositório entre estágios, uma passagem de revisão dedicada e rotulada como segurança antes do deploy, e evals contínuas que publicam indicadores de entrega antecedentes e posteriores.',
        audience:
          'Equipes que avaliam o playbook de entrega de software de ponta a ponta do Claude Code e o seu ciclo de feedback em produção.',
      },
      'vendor-native': {
        name: 'Modos de planejamento nativos do fornecedor',
        whatItDoesWell:
          'Claude Code, Codex, Cursor e Gemini CLI trazem modos de planejamento, arquivos de instrução e skills construídos sobre os padrões abertos e multifornecedor AGENTS.md e Agent Skills, ainda que o comportamento exato do modo de planejamento continue dependendo do fornecedor, do cliente e da versão. O Agent Skills, em particular, carrega apenas um resumo curto na inicialização e as instruções completas apenas na ativação, mantendo fora do contexto a capacidade que não está em uso.',
        audience:
          'Qualquer pessoa que queira planejamento dentro de um único agente sem adotar uma metodologia.',
      },
    },
    aiNative: {
      title: 'Onde isso se encaixa no SDLC nativo de IA',
      body: 'O playbook de SDLC nativo de IA da Claude descreve um ciclo completo: Plan, Design, Build, Test, Deploy e Maintain. Cada estágio comita um artefato que o próximo lê, com uma aprovação humana obrigatória em cada estágio e uma passagem de segurança dedicada antes do deploy, enquanto o feedback de produção se torna nova intenção.',
      shared:
        'O DWP compartilha as ideias de artefato duradouro e aprovação com gates: a intenção se torna um plano, as tarefas deixam evidências, uma passagem de segurança é executada antes da conclusão, e o repositório permanece legível para o próximo agente.',
      boundary:
        'A diferença real está no escopo, não no rigor: o playbook é construído em torno do Claude Code especificamente, enquanto o harness e o formato de plano do DWP podem ser lidos por qualquer agente que siga os padrões AGENTS.md e Agent Skills. O playbook também cobre avaliação contínua e operações de produção que o DWP não reivindica; essas práticas operacionais podem complementar um repositório conduzido pelo DWP, em vez de competir com ele.',
      sourceLabel: 'Ler o playbook de SDLC nativo de IA da Claude',
    },
    ...
    dwpStrengths: {
      ...
      items: [
        ...
        },
        {
          ...
          body: 'Um script comitado publica duas medições por fluxo — o pacote de entrada que carrega no início de uma sessão, e o caminho de ponta a ponta quando seus gatilhos reais disparam —, além do que cada uma exclui, de modo que o número de entrada nunca seja lido como o custo total de uma execução. Os resultados, incluindo os aumentos, são publicados como bytes, nunca como porcentagens de tokens ou de custo.',
        },
      ],
    },
    honestLimits: {
      title: 'Limitações honestas',
      body: 'O Deep Work Plan não tem um mecanismo de especificação viva ou delta; OpenSpec e ferramentas semelhantes são mais fortes aí. Ainda não existe um benchmark independente da metodologia; uma avaliação própria com agentes novos já foi executada sob um protocolo congelado, em pequena escala — uma carga de trabalho, dois recursos por configuração, uma máquina — e seus resultados são publicados nas duas direções: agentes em árvores com harness leram menos bytes nas duas tarefas, e as sessões da versão atual consumiram menos entrada e saída de modelo, reportada pelo harness, do que as da versão maior anterior, enquanto a direção líquida de tokens por carga de trabalho foi mista e nenhuma vantagem de tempo de relógio é reivindicada. O registro de carga de instrução mede bytes carregados, não tokens, custo ou resultados, e seu número de pacote de entrada não limita o que uma execução lê. O DWP é deliberadamente limitado ao repositório: não é um sistema de memória entre projetos, nem um framework de agentes baseado em papéis, nem um IDE, então também não compete nessas frentes — combine-o com uma ferramenta que cubra essa frente quando for isso que o trabalho exigir.',
    },
    correction: {
  ...
  developersPage: {
    ...
    planTitle: 'Planeje e execute com a skill',
    planIntro:
    ...
    commands: [
      {
        ...
        description:
          'Transforma um objetivo em plano — Lite por padrão, Full para trabalho maior, qualquer um dos modos da tabela acima.',
        href: '/kit/dwp-create',
      },
      {
        name: '/dwp-execute',
        description:
          'Executa um plano existente tarefa por tarefa: lê-o por completo, executa cada tarefa em ordem, valida seu gate, atualiza o progresso.',
        href: '/kit/dwp-execute',
      },
      {
        name: '/dwp-refine',
        description:
          'Adiciona, remove ou reordena tarefas em um plano existente preservando o trabalho concluído e suas evidências registradas.',
        href: '/kit/dwp-refine',
      },
      {
        name: '/dwp-resume',
        description:
          'Reconstrói o estado a partir dos próprios arquivos do plano e continua um plano interrompido a partir da primeira tarefa incompleta.',
        href: '/kit/dwp-resume',
      },
      {
        name: '/dwp-status',
        description:
          'Reporta o progresso de um plano — tarefas concluídas, em andamento, pendentes — sem fazer nenhuma alteração.',
        href: '/kit/dwp-status',
      },
      {
        name: '/dwp-verify',
        description:
          'Verifica, mecanicamente, se o repositório é AI-first e se seus planos estão bem formados. Não muda nada; reporta aprovado ou reprovado.',
        href: '/kit/dwp-verify',
      },
      {
        name: '/deepworkplan-onboard',
        description:
          'Torna um repositório AI-first: raciocina sobre seu stack e gera um AGENTS.md, docs/, .agents/ adaptados e um .dwp/ ignorado pelo git.',
        href: '/kit/deepworkplan-onboard',
      },
      {
        name: '/skill-create, /agent-create',
        description:
          'A sub-skill de autoria: expande o próprio kit do repositório — uma skill reutilizável para um procedimento repetível, ou um agente para um papel recorrente com seu próprio modelo e ferramentas.',
        href: '/kit/skill-create',
      },
      {
        name: '/dwp-upgrade',
        description:
          'Verifica se há um release mais novo da skill publicada e, somente após aprovação explícita, instala-o e reexecuta o onboarding como uma passagem nova — todo plano em andamento sob .dwp/ permanece intocado.',
        href: '/kit',
      },
    ],
    examplesTitle: 'Duas formas de executá-la',
    examplesIntro:
    ...
    quickFixLabel: 'Uma correção pequena e delimitada — Lite, trust',
    quickFixBody:
    ...
    longHorizonLabel: 'Trabalho de longo alcance — Full, guided',
    longHorizonBody:
    ...
    planCodeLabel: 'Terminal — comandos de barra',
    planNote:
