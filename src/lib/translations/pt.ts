...
export const pt: SiteTranslations = {
    ...
    agents: {
      ...
      items: [
        ...
        },
        {
          name: 'GitHub Copilot',
          support: 'partial',
          note: 'Apenas docs e AGENTS.md. Slash commands via extensões.',
        },
        {
          name: 'Gemini',
          support: 'full',
  ...
  quickstartPage: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          'Use /skill-create e /agent-create (a sub-skill author) para desenvolver skills, agents e commands apropriados à sua stack. O onboarding também oferece três addons opcionais — devcontainer, Dailybot e dependency-upgrade — que você aceita apenas quando fizerem sentido.',
      },
      {
  ...
  trustPage: {
    ...
    disclosureBody:
      'Encontrou um problema de segurança? Reporte-o de forma privada para security@dailybot.com em vez de abrir uma issue pública. Confirmamos os reportes em até 3 dias úteis e buscamos publicar uma correção ou mitigação em 30 dias para descobertas válidas, dependendo da gravidade. O site e a skill compartilham a mesma política.',
