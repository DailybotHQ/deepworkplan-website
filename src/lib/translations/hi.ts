...
export const hi: SiteTranslations = {
  ...
  home: {
    ...
    hero: {
      ...
      instructionLabel: 'अपने एजेंट को यह दें',
      instruction:
    ...
    onboarding: {
      ...
      steps: [
        ...
        {
          title: '.claude से .agents सिमलिंक के साथ .agents/ का ढाँचा बनाता है',
          description:
            'एक क्रॉस-एजेंट .agents/ डायरेक्टरी (स्किल्स, एजेंट्स, कमांड्स) और .claude से .agents सिमलिंक, जो CLAUDE.md को AGENTS.md से मिरर करता है, ताकि हर उपकरण सत्य के एक ही स्रोत को पढ़े।',
        },
        {
    ...
    outcomes: {
      ...
      items: [
        ...
        {
          label: '.claude से .agents सिमलिंक के साथ .agents/',
          detail:
            'एक क्रॉस-एजेंट .agents/ डायरेक्टरी (स्किल्स, एजेंट्स, कमांड्स) जिसमें .claude से .agents सिमलिंक है, ताकि हर उपकरण सत्य के एक ही स्रोत को पढ़े।',
        },
        {
  ...
  quickstartPage: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          'onboard सब-स्किल चलाएँ और एजेंट को अपनी वास्तविक रिपॉज़िटरी पर तर्क करने दें। यह AGENTS.md, एक docs/ ज्ञान-आधार, प्रति-मॉड्यूल docs, और एक क्रॉस-एजेंट .agents/ घर (.claude → .agents सिमलिंक के साथ) तैयार करता है, पतले dwp-* कमांड्स जोड़ता है, और एक gitignored .dwp/ का ढाँचा बनाता है।',
        commands: ['/deepworkplan-onboard'],
      },
      {
        title: 'किट विकसित करें और ऐडऑन स्वीकार करें',
        description:
          'स्टैक-उपयुक्त स्किल्स, एजेंट्स और कमांड्स विकसित करने के लिए /skill-create और /agent-create (author सब-स्किल) का उपयोग करें। ऑनबोर्डिंग तीन ऑप्ट-इन ऐडऑन भी प्रदान करती है — devcontainer, Dailybot और dependency-upgrade — जिन्हें आप तभी स्वीकार करते हैं जब वे उपयुक्त हों।',
      },
      {
  ...
  trustPage: {
    ...
    disclosureBody:
      'कोई सुरक्षा समस्या मिली? सार्वजनिक issue खोलने के बजाय इसे निजी तौर पर security@dailybot.com पर रिपोर्ट करें। हम 3 व्यावसायिक दिनों के भीतर रिपोर्ट को स्वीकार करते हैं और गंभीरता के आधार पर वैध निष्कर्षों के लिए 30 दिनों के भीतर एक फिक्स या शमन भेजने का लक्ष्य रखते हैं। वेबसाइट और स्किल एक ही नीति साझा करते हैं।',
  ...
  initPage: {
    ...
    handoffTitle: 'यह अपने एजेंट को दें',
    handoffBody:
      'नीचे दी पंक्ति अपने AI कोडिंग एजेंट में पेस्ट करें। यह पद्धति और विनिर्देश पढ़ेगा, स्किल स्थापित करेगा, और इस रिपॉज़िटरी को Deep Work Plans के लिए ऑनबोर्ड करेगा।',
    handoffInstruction:
      'इस रिपॉज़िटरी को AI-first बनाने के लिए https://deepworkplan.com/init.md पर दिए निर्देश पढ़ें और उनका पालन करें।',
    ...
    steps: [
      ...
      },
      {
        title: 'किट विकसित करें और ऐडऑन स्वीकार करें',
        description:
          'स्टैक-उपयुक्त स्किल्स, एजेंट्स और कमांड्स विकसित करने के लिए /skill-create और /agent-create (author सब-स्किल) का उपयोग करें। ऑनबोर्डिंग तीन ऑप्ट-इन ऐडऑन भी प्रदान करती है — devcontainer, Dailybot और dependency-upgrade — जिन्हें आप तभी स्वीकार करते हैं जब वे उपयुक्त हों। एक रिपॉज़िटरी शून्य ऐडऑन के साथ भी पूर्णतः अनुरूप होती है।',
      },
      {
        title: 'योजना बनाएँ और निष्पादित करें',
        description:
