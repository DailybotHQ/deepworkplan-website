        ...
        items: [
          {
            ...
            answer:
              'ऑनबोर्डिंग गैर-विनाशकारी है: यह मौजूदा `AGENTS.md`, `docs/`, `.agents/` या `CLAUDE.md` को पहचानती है, अधिलेखित करने के बजाय सुलझाती है, और कुछ भी बदलने से पहले पूछती है। यह वास्तविक कमांड्स वाला `AGENTS.md` इंडेक्स, एक तर्कपूर्ण `docs/` वृक्ष, प्रति-मॉड्यूल docs, पतले `dwp-*` कमांड्स वाली `.agents/` किट, एक gitignored `.dwp/` आउटपुट क्षेत्र, एक सत्यापित टेस्टिंग मैप, और अनिवार्य स्थानीय कोड समीक्षा (AI Diff Reviewer स्किल और रिपॉज़िटरी-अनुरूप समीक्षा एक्सटेंशन) लिखती है। फिर वह एक स्व-जाँच और अनुरूपता परीक्षक चलाती है ताकि आप देख सकें कि क्या बना। किसी पुराने मानक के तहत ऑनबोर्ड रिपॉज़िटरी को एक लक्षित harness अपग्रेड मिलता है जो केवल जो गायब या पुराना है उसे सुलझाता है। स्किल को खुद अपग्रेड करना एक अलग, स्पष्ट सहमति से चलने वाला प्रवाह है (`/dwp-upgrade`): यह नवीनतम प्रकाशित संस्करण को केवल-पढ़ने योग्य तरीके से जाँचता है, केवल आपकी स्पष्ट स्वीकृति के बाद ही इंस्टॉल करता है, ऑनबोर्डिंग को एक ताज़ा रन की तरह दोबारा चलाता है, और `.dwp/` के तहत मौजूद योजनाओं को कभी माइग्रेट या अमान्य नहीं करता।',
