...
export const hi: SiteTranslations = {
  ...
  announcementBar: {
    badge: 'नया · संरचना द्वारा संदर्भ-कुशल',
  ...
  home: {
    ...
    pitch: {
      ...
      efficiency:
        'और क्योंकि संदर्भ आपके एजेंट का सबसे दुर्लभ संसाधन है, harness अपनी ही निर्देश-भार को छोटा और ऑडिट-योग्य रखने के लिए डिज़ाइन किया गया है: निर्देश प्रगतिशील रूप से लोड होते हैं, सत्यापन केवल बदले हुए पर लागू होता है, और हर कार्य स्थानीय रूप से सीखता है। हर flow का भार बाइट्स में मापा जाता है और हर रिलीज़ पर प्रकाशित होता है — नवीनतम रिलीज़ ने execute flow को 45.7% और resume flow को 67.5% घटाया। प्लान खुद भी इसी सिद्धांत के अनुसार स्केल करता है: एक सीमित सुधार के लिए Lite प्लान, घंटों तक चलने वाले काम के लिए Full प्लान — फ़ॉर्मेट हमेशा काम के दायरे के अनुरूप होता है, इसका उल्टा नहीं।',
      illustrationAlt:
    ...
    story: {
      ...
      act5: {
        kicker: 'पद्धति · अंक V',
        lead: 'संदर्भ आपके एजेंट का सबसे दुर्लभ संसाधन है। harness प्रगतिशील रूप से लोड होता है, केवल बदले हुए को सत्यापित करता है और कार्य दर कार्य सीखता है — हर flow का निर्देश-भार मापा और प्रकाशित जाता है, रिलीज़ दर रिलीज़।',
        deepLinkLabel: 'पद्धति पढ़ें',
        deepLinkHref: '/methodology',
      },
    },
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            id: 'unverified',
            question: 'जब अनुरूपता परीक्षक अपनी जाँचें नहीं चला सकता तो क्या होता है?',
            answer:
      ...
      },
      {
        ...
        items: [
          {
            id: 'multi-repo',
            question: 'क्या एक योजना कई रिपॉज़िटरी पर फैल सकती है?',
            answer:
            ...
            linkLabel: 'रिपॉज़िटरी आर्किटाइप',
            linkPath: '/spec/archetypes',
          },
          {
            id: 'vs-sdd-tools',
      ...
      },
      {
        ...
        items: [
          ...
          {
            id: 'upgrade',
            question: 'पहले से onboard की गई रिपॉज़िटरी में स्किल को कैसे अपग्रेड करें?',
            answer:
    ...
    dwpStrengths: {
      ...
      items: [
        ...
        },
        {
          ...
          body: 'एक कमिट स्क्रिप्ट हर flow के लिए दो माप प्रकाशित करती है — सत्र की शुरुआत में लोड होने वाला प्रवेश बंडल, और flow के वास्तविक ट्रिगर सक्रिय होने पर एंड-टू-एंड पाथ — साथ ही हर माप क्या शामिल नहीं करता, ताकि प्रवेश आँकड़ा अकेले कभी किसी रन की कुल लागत के रूप में न पढ़ा जाए। परिणाम — वृद्धियों सहित — bytes के रूप में प्रकाशित होते हैं, कभी टोकन या लागत प्रतिशत के रूप में नहीं।',
        },
      ],
    },
    honestLimits: {
  ...
  developersPage: {
    ...
    planTitle: 'स्किल के साथ योजना बनाएँ और निष्पादित करें',
    planIntro:
      'ऊपर दिया गया API किसी एजेंट को यह साइट पढ़ने देता है। DWP स्किल वह है जो किसी एजेंट को पद्धति चलाने देती है — इसे किसी रिपॉज़िटरी में एक बार इंस्टॉल करें और यह एक राउटर तथा नौ सब-स्किल्स लाती है, जिन्हें स्लैश कमांड के रूप में (या नाम से, उन एजेंटों के लिए जो स्लैश को intercept करते हैं — अधिकांश इसके बजाय # का उपयोग करते हैं, जैसे #dwp-execute) आमंत्रित किया जाता है।',
    formatTitle: 'दो स्वतंत्र विकल्प: फ़ॉर्मेट, और आप कितनी समीक्षा चाहते हैं',
    formatIntro:
      'हर योजना हर अक्ष से एक मान चुनती है। ये स्वतंत्र हैं — एक Lite योजना trust मोड में चल सकती है, एक Full योजना guided मोड में चल सकती है, और दोनों फ़ॉर्मेट बदले बिना बाद में मोड बदल सकती हैं।',
    formatAxes: [
      {
        title: 'Lite',
        body: 'कार्य-रिकॉर्ड योजना के README में ही, स्थिर #task-N एंकरों के पीछे रहते हैं — कोई अलग कार्य फ़ाइल नहीं। छोटे, सीमित काम के लिए बनाया गया: एक सरोकार, लगभग एक बैठक। फिर भी एक पूर्ण योजना: स्थिर कार्य-आईडी, एक Touched Surface, स्वीकृति मानदंड, एक सत्यापन gate, और एक Final Review — कभी भी घटाया हुआ स्केच नहीं।',
      },
      {
        title: 'Full',
        body: 'N.task_<slug>.md के अंतर्गत प्रति कार्य एक फ़ाइल, घंटों या दिनों तक फैले लंबी-अवधि के काम के लिए, या जब किसी योजना में कार्यों के बीच वास्तविक निर्भरताएँ हों। जब संक्षिप्त रिकॉर्ड पर्याप्त नहीं रह जाते, तो एक Lite योजना बाद में /dwp-refine promote के साथ Full में उन्नत हो जाती है — उन्नयन पूर्ण हो चुके काम को कभी दोबारा नहीं चलाता।',
      },
      {
        title: 'Guided (डिफ़ॉल्ट)',
        body: 'dwp-create लक्ष्य का विश्लेषण करता है, उसे विभाजित करता है, और एक समीक्षा योग्य योजना तैयार करता है — जो पहले से ही वास्तविक, निष्पादन योग्य योजना है, कभी भी डिस्पोज़ेबल ड्राफ्ट नहीं — फिर पूछता है: इसे रखें, Lite को Full में उन्नत करें, इसे संपादित करें, या रोकें। किसी भी उत्पाद-कार्य के शुरू होने से पहले एक मनुष्य लूप में बना रहता है। पहली कुछ बार के लिए, या अधिक जोखिम वाले किसी भी काम के लिए अनुशंसित।',
      },
      {
        title: 'Trust (या auto)',
        body: 'अंतिम शब्द के रूप में trust (या auto) जोड़ें — जैसे /dwp-create <goal> trust — और एजेंट समीक्षा चरण को छोड़ देता है, एक पूर्व-अनुमोदित योजना तैयार करता है, और सीधे execute कमांड लौटाता है। एक बार जब आप प्रवाह पर भरोसा कर लेते हैं तो यह पावर-यूज़र शॉर्टकट है; यह अब भी हर निर्णय और gate को रिकॉर्ड करता है, बस पूछने के लिए रुकता नहीं।',
      },
    ],
    commandsTitle: 'नौ सब-स्किल्स',
    commandsIntro:
      'हर सब-स्किल को उस रिपॉज़िटरी के भीतर एक स्लैश कमांड के रूप में आमंत्रित किया जाता है जिसने स्किल इंस्टॉल की है — इस वेबसाइट के विरुद्ध नहीं। हर एक का पूरा संदर्भ किट कैटलॉग में है।',
    commands: [
      {
        name: '/dwp-create <goal>',
        description:
          'किसी लक्ष्य को योजना में बदलें — डिफ़ॉल्ट रूप से Lite, बड़े काम के लिए Full, ऊपर दी गई तालिका से कोई भी मोड।',
        href: '/kit/dwp-create',
      },
      {
        name: '/dwp-execute',
        description:
          'किसी मौजूदा योजना को कार्य-दर-कार्य चलाएँ: इसे पूरी तरह पढ़ें, हर कार्य को क्रम में निष्पादित करें, उसके gate को सत्यापित करें, प्रगति अपडेट करें।',
        href: '/kit/dwp-execute',
      },
      {
        name: '/dwp-refine',
        description:
          'पूर्ण हो चुके काम और उसके दर्ज साक्ष्य को सुरक्षित रखते हुए किसी मौजूदा योजना में कार्य जोड़ें, हटाएँ, या पुनः क्रमबद्ध करें।',
        href: '/kit/dwp-refine',
      },
      {
        name: '/dwp-resume',
        description:
          'योजना की अपनी फ़ाइलों से स्थिति फिर से बनाएँ और किसी बाधित योजना को उसके पहले अधूरे कार्य से जारी रखें।',
        href: '/kit/dwp-resume',
      },
      {
        name: '/dwp-status',
        description:
          'बिना कोई बदलाव किए किसी योजना की प्रगति की रिपोर्ट दें — पूर्ण, प्रगति में, लंबित कार्य।',
        href: '/kit/dwp-status',
      },
      {
        name: '/dwp-verify',
        description:
          'यंत्रवत् जाँच करें कि क्या रिपॉज़िटरी AI-first है और क्या उसकी योजनाएँ सुगठित हैं। कुछ भी नहीं बदलता; पास या फ़ेल की रिपोर्ट देता है।',
        href: '/kit/dwp-verify',
      },
      {
        name: '/deepworkplan-onboard',
        description:
          'किसी रिपॉज़िटरी को AI-first बनाएँ: उसके स्टैक के बारे में तर्क करें, फिर एक अनुकूलित AGENTS.md, docs/, .agents/, और एक gitignore की गई .dwp/ जनरेट करें।',
        href: '/kit/deepworkplan-onboard',
      },
      {
        name: '/skill-create, /agent-create',
        description:
          'लेखक सब-स्किल: रिपॉज़िटरी की अपनी किट को बढ़ाएँ — दोहराई जाने वाली प्रक्रिया के लिए एक पुनः प्रयोज्य स्किल, या अपने ही मॉडल और टूल वाली आवर्ती भूमिका के लिए एक एजेंट।',
        href: '/kit/skill-create',
      },
      {
        name: '/dwp-upgrade',
        description:
          'किसी नए प्रकाशित स्किल रिलीज़ की जाँच करें और, केवल स्पष्ट अनुमोदन के बाद, उसे इंस्टॉल करें और ऑनबोर्डिंग को एक नए पास के रूप में फिर से चलाएँ — .dwp/ के अंतर्गत हर चल रही योजना अछूती रहती है।',
        href: '/kit',
      },
    ],
    examplesTitle: 'इसे चलाने के दो तरीके',
    examplesIntro:
      'वही स्किल, वही नौ कमांड — फ़ॉर्मेट और समीक्षा मोड काम के आकार और जोखिम के साथ बदलते हैं, टूल के साथ नहीं।',
    quickFixLabel: 'एक छोटा, सीमित सुधार — Lite, trust',
    quickFixBody:
      'एक सरोकार, लगभग एक बैठक, कम जोखिम: समीक्षा चरण छोड़ें और एजेंट को सीधे एक Lite योजना तैयार करने और चलाने दें।',
    longHorizonLabel: 'लंबी-अवधि का काम — Full, guided',
    longHorizonBody:
      'कार्यों के बीच वास्तविक निर्भरताएँ, या अधिक जोखिम: किसी भी उत्पाद-कार्य के शुरू होने से पहले प्रस्तावित योजना की समीक्षा करें, यदि लक्ष्य को इसकी आवश्यकता हो तो Full में उन्नत करें, फिर आवश्यकतानुसार सत्रों के पार निष्पादित करें और फिर से शुरू करें।',
    planCodeLabel: 'टर्मिनल — स्लैश कमांड',
    planNote:
