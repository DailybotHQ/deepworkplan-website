...
export const hi: SiteTranslations = {
  ...
  home: {
    ...
    pitch: {
      ...
      illustrationAlt:
        'एक नॉटिकल चार्ट जिसमें एकमात्र प्लॉट किया गया मार्ग खतरों को सुरक्षित रूप से पार करता है—एक उत्कीर्णन जो योजना को काम को पट्टे पर रखने वाली दिशा के रूप में दर्शाता है।',
    },
    story: {
      act1: {
        kicker: 'पद्धति · अंक I',
