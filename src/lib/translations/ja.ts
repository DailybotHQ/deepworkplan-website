...
export const ja: SiteTranslations = {
  ...
  trustPage: {
    ...
    disclosureBody:
      'セキュリティ上の問題を見つけましたか？公開 Issue を立てるのではなく、security@dailybot.com にプライベートで報告してください。報告は 3 営業日以内に確認し、有効な発見については深刻度に応じて 30 日以内に修正または緩和策を提供することを目指しています。ウェブサイトとスキルは同じポリシーを共有しています。',
