...
export const ko: SiteTranslations = {
  ...
  trustPage: {
    ...
    disclosureBody:
      '보안 문제를 발견하셨나요? 공개 이슈를 열지 말고 security@dailybot.com으로 비공개 신고해 주세요. 신고는 영업일 기준 3일 이내에 확인하며, 유효한 발견에 대해서는 심각도에 따라 30일 이내에 수정 또는 완화 방안을 제공하는 것을 목표로 합니다. 웹사이트와 스킬은 동일한 정책을 공유합니다.',
