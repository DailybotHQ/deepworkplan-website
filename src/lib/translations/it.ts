...
export const it: SiteTranslations = {
  ...
  nav: {
    ...
    compare: 'Confronto',
    resources: 'Risorse',
    resourcesDesc: 'Esempi, confronto, FAQ e fiducia',
    repo: {
