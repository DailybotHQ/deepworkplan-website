...
export const th: SiteTranslations = {
  ...
  announcementBar: {
    badge: 'ใหม่ · ประหยัดบริบทโดยการออกแบบ',
  ...
  home: {
    ...
    pitch: {
      ...
      efficiency:
        'และเพราะคอนเท็กซ์คือทรัพยากรที่หายากที่สุดของเอเจนต์ harness จึงถูกออกแบบมาเพื่อให้ภาระคำสั่งของตัวมันเองเล็กและตรวจสอบได้: คำสั่งโหลดแบบขั้นเป็นขั้น การตรวจสอบแตะต้องเฉพาะสิ่งที่เปลี่ยน และแต่ละงานเรียนรู้ในที่ของมัน ภาระของแต่ละโฟลว์ถูกวัดเป็นไบต์และเผยแพร่ในทุกการเผยแพร่ — การเผยแพร่ล่าสุดลดโฟลว์ execute ลง 45.7% และโฟลว์ resume ลง 67.5% แผนเองก็ปรับขนาดตามหลักการเดียวกัน: แผน Lite สำหรับการแก้ไขที่มีขอบเขตจำกัด แผน Full สำหรับงานที่ยาวนานหลายชั่วโมง — รูปแบบจะเป็นไปตามขอบเขตของงานเสมอ ไม่ใช่ในทางกลับกัน',
      illustrationAlt:
    ...
    story: {
      ...
      act5: {
        ...
        lead: 'คอนเท็กซ์คือทรัพยากรที่หายากที่สุดของเอเจนต์ harness โหลดแบบขั้นเป็นขั้น ตรวจสอบเฉพาะสิ่งที่เปลี่ยน และเรียนรู้ทีละงาน — ภาระคำสั่งของทุกโฟลว์ถูกวัดและเผยแพร่ต่อเนื่องในทุกการเผยแพร่',
        deepLinkLabel: 'อ่านวิธีการ',
        deepLinkHref: '/methodology',
      },
    },
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            id: 'unverified',
            question: 'เกิดอะไรขึ้นเมื่อตัวตรวจสอบความสอดคล้องรันการตรวจสอบของมันไม่ได้?',
            answer:
      ...
      },
      {
        ...
        items: [
          {
            id: 'multi-repo',
            question: 'แผนหนึ่งแผนครอบคลุมหลาย repository ได้ไหม?',
            answer:
            ...
            linkLabel: 'อาร์เคไทป์ของ repository',
            linkPath: '/spec/archetypes',
          },
          {
            id: 'vs-sdd-tools',
      ...
      },
      {
        ...
        items: [
          ...
          {
            id: 'upgrade',
            question: 'อัปเกรดสกิลใน repository ที่เริ่มต้นไว้แล้วอย่างไร?',
            answer:
  ...
  developersPage: {
    ...
    planTitle: 'วางแผนและดำเนินการด้วยสกิล',
    planIntro:
    ...
    formatTitle: 'สองทางเลือกที่เป็นอิสระจากกัน: รูปแบบ และปริมาณการตรวจทานที่ต้องการ',
    formatIntro:
      'ทุกแผนเลือกค่าหนึ่งจากแต่ละแกน ทั้งสองแกนเป็นอิสระจากกัน — แผน Lite รันแบบ trust ได้ แผน Full รันแบบ guided ได้ และแต่ละแผนสามารถเปลี่ยนโหมดภายหลังได้โดยไม่ต้องเปลี่ยนรูปแบบ',
    formatAxes: [
      {
        title: 'Lite',
        body: 'บันทึกงานอยู่ใน README ของแผนโดยตรง อยู่หลัง anchor #task-N ที่คงที่ — ไม่มีไฟล์งานแยกต่างหาก สร้างมาสำหรับงานเล็กและมีขอบเขตจำกัด: ประเด็นเดียว ประมาณหนึ่งรอบการทำงาน ยังคงเป็นแผนที่สมบูรณ์: มี task id ที่คงที่ Touched Surface เกณฑ์การยอมรับ validation gate และ Final Review — ไม่เคยเป็นแค่โครงร่างที่ตัดทอน',
      },
      {
        title: 'Full',
        body: 'หนึ่งไฟล์ต่อหนึ่งงานภายใต้ N.task_<slug>.md สำหรับงานระยะยาวที่กินเวลาหลายชั่วโมงหรือหลายวัน หรือเมื่อแผนมีการพึ่งพากันจริงระหว่างงาน แผน Lite จะยกระดับเป็น Full ภายหลังด้วย /dwp-refine promote เมื่อบันทึกแบบกระชับไม่เพียงพออีกต่อไป — การยกระดับไม่เคยรันงานที่เสร็จแล้วซ้ำ',
      },
      {
        title: 'Guided (ค่าเริ่มต้น)',
        body: 'dwp-create วิเคราะห์เป้าหมาย แตกย่อย และสร้างแผนที่ตรวจทานได้ — ซึ่งเป็นแผนจริงที่รันได้อยู่แล้ว ไม่ใช่ร่างทิ้งขว้าง — จากนั้นถาม: เก็บไว้ตามเดิม ยกระดับ Lite เป็น Full แก้ไข หรือหยุด มนุษย์ยังอยู่ในลูปก่อนงานจริงใด ๆ จะเริ่มต้น แนะนำสำหรับไม่กี่ครั้งแรก หรือสำหรับงานที่มีความเสี่ยงสูงกว่า',
      },
      {
        title: 'Trust (หรือ auto)',
        body: 'เติม trust (หรือ auto) เป็นคำสุดท้าย — เช่น /dwp-create <goal> trust — แล้ว agent จะข้ามรอบตรวจทาน สร้างแผนที่อนุมัติล่วงหน้า และคืนคำสั่ง execute ให้ทันที เป็นทางลัดสำหรับผู้ใช้ที่ไว้ใจ flow แล้ว ยังคงบันทึกทุกการตัดสินใจและทุก gate เพียงแต่ไม่หยุดถาม',
      },
    ],
    commandsTitle: 'สกิลย่อยทั้งเก้าตัว',
    commandsIntro:
      'สกิลย่อยแต่ละตัวถูกเรียกเป็น slash command ภายใน repository ที่ติดตั้งสกิลไว้ — ไม่ใช่กับเว็บไซต์นี้ รายละเอียดฉบับเต็มของแต่ละตัวอยู่ใน kit catalog',
    commands: [
      {
        name: '/dwp-create <goal>',
        description:
          'แปลงเป้าหมายให้เป็นแผน — เป็น Lite โดยดีฟอลต์ เป็น Full สำหรับงานที่ใหญ่กว่า เลือกโหมดใดก็ได้ตามตารางด้านบน',
        href: '/kit/dwp-create',
      },
      {
        name: '/dwp-execute',
        description:
          'รันแผนที่มีอยู่ทีละงาน: อ่านให้ครบถ้วน ดำเนินงานแต่ละงานตามลำดับ ตรวจสอบ gate ของมัน อัปเดตความคืบหน้า',
        href: '/kit/dwp-execute',
      },
      {
        name: '/dwp-refine',
        description:
          'เพิ่ม ลบ หรือจัดลำดับงานใหม่ในแผนที่มีอยู่ โดยรักษางานที่เสร็จแล้วและหลักฐานที่บันทึกไว้',
        href: '/kit/dwp-refine',
      },
      {
        name: '/dwp-resume',
        description:
          'สร้างสถานะขึ้นใหม่จากไฟล์ของแผนเอง และดำเนินแผนที่ถูกขัดจังหวะต่อจากงานที่ยังไม่เสร็จตัวแรก',
        href: '/kit/dwp-resume',
      },
      {
        name: '/dwp-status',
        description:
          'รายงานความคืบหน้าของแผน — เสร็จแล้ว กำลังดำเนินการ งานที่รอดำเนินการ — โดยไม่เปลี่ยนแปลงอะไร',
        href: '/kit/dwp-status',
      },
      {
        name: '/dwp-verify',
        description:
          'ตรวจสอบอย่างเป็นกลไกว่า repository เป็น AI-first หรือไม่ และแผนของมันมีโครงสร้างถูกต้องหรือไม่ ไม่เปลี่ยนแปลงอะไร รายงานแค่ผ่านหรือไม่ผ่าน',
        href: '/kit/dwp-verify',
      },
      {
        name: '/deepworkplan-onboard',
        description:
          'ทำให้ repository เป็น AI-first: ให้เหตุผลเกี่ยวกับสแตกของมัน แล้วสร้าง AGENTS.md, docs/, .agents/ ที่ปรับให้เหมาะสม และ .dwp/ ที่ถูก gitignore',
        href: '/kit/deepworkplan-onboard',
      },
      {
        name: '/skill-create, /agent-create',
        description:
          'สกิลย่อยสำหรับผู้เขียน: ขยาย kit ของ repository เอง — สกิลที่นำกลับมาใช้ได้สำหรับขั้นตอนที่ทำซ้ำ หรือ agent สำหรับบทบาทที่เกิดซ้ำพร้อมโมเดลและเครื่องมือของตัวเอง',
        href: '/kit/skill-create',
      },
      {
        name: '/dwp-upgrade',
        description:
          'ตรวจสอบว่ามีสกิลรุ่นใหม่เผยแพร่หรือไม่ และหลังได้รับอนุมัติอย่างชัดเจนเท่านั้น จึงติดตั้งและรัน onboarding ใหม่อีกครั้ง — ทุกแผนที่กำลังดำเนินอยู่ภายใต้ .dwp/ จะไม่ถูกแตะต้อง',
        href: '/kit',
      },
    ],
    examplesTitle: 'สองวิธีในการรัน',
    examplesIntro:
      'สกิลเดียวกัน คำสั่งเก้าคำสั่งเดียวกัน — รูปแบบและโหมดตรวจทานเปลี่ยนไปตามขนาดและความเสี่ยงของงาน ไม่ใช่ตามเครื่องมือ',
    quickFixLabel: 'การแก้ไขเล็ก ๆ ที่มีขอบเขตจำกัด — Lite, trust',
    quickFixBody:
      'ประเด็นเดียว ประมาณหนึ่งรอบการทำงาน ความเสี่ยงต่ำ: ข้ามรอบตรวจทานและให้ agent สร้างและรันแผน Lite โดยตรง',
    longHorizonLabel: 'งานระยะยาว — Full, guided',
    longHorizonBody:
      'มีการพึ่งพากันจริงระหว่างงาน หรือความเสี่ยงสูงกว่า: ตรวจทานแผนที่เสนอก่อนที่งานจริงใด ๆ จะเริ่ม ยกระดับเป็น Full หากเป้าหมายต้องการ แล้วรันและกลับมาทำต่อข้ามเซสชันได้ตามต้องการ',
    planCodeLabel: 'เทอร์มินัล — slash command',
    planNote:
