...
export const th: SiteTranslations = {
  ...
  trustPage: {
    ...
    disclosureBody:
      'พบปัญหาด้านความปลอดภัย รายงานเป็นการส่วนตัวที่ security@dailybot.com แทนที่จะเปิด issue สาธารณะ เราตอบรับรายงานภายใน 3 วันทำการและมุ่งส่งแพตช์หรือมาตรการบรรเทาภายใน 30 วันสำหรับการค้นพบที่ถูกต้อง ขึ้นอยู่กับความรุนแรง เว็บไซต์และสกิลใช้นโยบายเดียวกัน',
