...
Create multilingual blog posts (currently English + Spanish) for Deep Work Plan using Astro Content Collections. Supports two modes:
...
- First person (I, my, me) — the post author
...
### Example 1: Topic Mode — Case Study Article

**Input:**
```
$TOPIC: Case study about adopting the Deep Work Plan methodology on a real project.
$TAG: methodology
$PUB_DATE: 2026-05-30
$HERO_IMAGE: /images/blog/posts/adopting-deep-work-plan/hero.jpg
```

**Creates:**
- `src/content/blog/en/2026-05-30_adopting-deep-work-plan.md` (written from scratch)
- `src/content/blog/es/2026-05-30_adopting-deep-work-plan.md` (translated)
- Narrative with first-person voice, sections about the methodology, validation gates, lessons learned
