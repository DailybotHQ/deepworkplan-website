...
- The original tier-3 design spec (if present): the corresponding plan under `.dwp/plans/` (e.g. `PLAN_implement_third_level_tags_taxonomy/analysis_results/TIER_3_DESIGN_SPEC.md`).
