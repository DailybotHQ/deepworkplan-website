...
2. Write in first person — the post author
...
### Example 1: Case Study Article from Brief

**Request:**

```
Write a case study about adopting the Deep Work Plan methodology on a real project.
Repo: github.com/DailybotHQ/deepworkplan-website
```

**Agent Response:**

Creates two files with a narrative-driven article:
- Opens with the context: the problem the team faced before adopting DWP
- Breaks down how the methodology was applied (tasks, validation gates, completion protocol)
- Includes concrete before/after examples and code snippets where helpful
- Shares honest reflections on what worked and what didn't
- Closes with lessons learned
- Ends with Resources section linking to the methodology and kit docs
