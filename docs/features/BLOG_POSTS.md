...
│   │   │   └── ...
│   │   ├── 2020-12-31_adopting-dwp-case-study.md
...
```markdown
---
title: 'Adopting Deep Work Plan'
description: 'How one team adopted the Deep Work Plan methodology to drive AI coding agents through a complex migration.'
pubDate: '2020-12-31'
heroImage: '/images/blog/posts/adopting-dwp-case-study/hero.jpg'
heroLayout: 'side-by-side'
tags: ['portfolio', 'personal', 'design']
keywords: ['Deep Work Plan case study', 'AI coding agents workflow', 'agent methodology adoption', 'DWP methodology', 'reliable agent execution']
---
```
...
```
Blog Post: series: "adopting-dwp", seriesOrder: 2
                    │                              │
                    ▼                              ▼
Series Collection: adopting-dwp.md    Sort position
                    │
                    ▼
...
```yaml
series: "adopting-dwp"   # References series name
...
This pattern mirrors the `ScrollToTimeline.svelte` component (a floating pill), but with series-specific content and blue theming.
