...
├── methodology/         # /methodology/* (English)
└── es/
    ├── index.astro      # /es (Spanish)
    └── methodology/     # /es/methodology/* (Spanish)
```
...
Create `fr/` subfolders under each content collection (`src/content/methodology/fr/`, `src/content/spec/fr/`, `src/content/kit/fr/`, `src/content/pages/fr/`) for translated docs.
...
- **Content Collections i18n**: Methodology/spec/kit docs split by language in `{collection}/en/` and `{collection}/es/`
