...
deepworkplan.com is primarily a static site, but includes a few API endpoints and data feeds:
...
<rss version="2.0">
  <channel>
    <title>Deep Work Plan Blog</title>
    <link>https://deepworkplan.com</link>
    <description>Blog posts from Deep Work Plan</description>
    <item>
      <title>Post Title</title>
      <link>https://deepworkplan.com/blog/post-slug/</link>
...
```
https://deepworkplan.com/rss.xml
```
