...
> faro hero) and HP-02 (the pitch chart) — remain **AI-generated images**;
...
| [prompts/01-homepage.md](./prompts/01-homepage.md) | Homepage prompts (HP-01 … HP-05). |
